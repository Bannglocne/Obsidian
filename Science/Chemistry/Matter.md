...
- In **[[molecules|molecules]]**, two or more **[[atoms]]** are joined together in specific shapes.
...
graph TD
    M[Matter] --> Q1{Uniform?}
    Q1 -- No --> HM[Heterogeneous<br>mixture]
    Q1 -- Yes --> H[Homogeneous]
    H --> Q2{Variable<br>composition?}
    Q2 -- Yes --> HMS[Homogeneous<br>mixture]
    Q2 -- No --> PS[Pure substance]
    PS --> Q3{Separable?}
    Q3 -- No --> E[Element]
    Q3 -- Yes --> C[Compound]
    style M fill:#fdebd0,stroke:#d35400
    style HM fill:#fdebd0,stroke:#d35400
    style H fill:#fdebd0,stroke:#d35400
    style HMS fill:#fdebd0,stroke:#d35400
    style PS fill:#fdebd0,stroke:#d35400
    style E fill:#fdebd0,stroke:#d35400
    style C fill:#fdebd0,stroke:#d35400
...
3. **Compounds** are substances composed of two or more elements; they contain two or more kinds of [[molecules#Atoms|atoms]]
