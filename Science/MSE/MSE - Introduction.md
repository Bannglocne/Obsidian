...
2. ==Properties== are a material's response to external stimuli, grouped into six categories:
	...
	- _==Optical==_: Response to light 
	- _==Deteriorative==_: Chemical reactivity
...
| **Category**   | **Composition & Structure**                                                                     | **Characteristics**                                                                                                                    |
| -------------- | ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| **Metals**     | Metallic elements (Fe, Al, Cu, etc.) often with nonmetals (C, N, O). Orderly crystal structure. | Dense, stiff, strong, ductile, and fracture-resistant.<br>Good conductors of heat and electricity.<br>Some have desirable magnetic propeties | 
| **Ceramics**   | Compounds of metallic and nonmetallic elements (oxides, nitrides, carbides).                    | Stiff, strong, and hard, but typically very brittle (low ductility).<br>Insulative and heat-resistant.                                    |
...
- **Nanomaterials:** Structural features <100 nm. Developed via "bottom-up" design (atom-by-atom). They exhibit unique quantum and surface properties distinct from macroscopic materials .