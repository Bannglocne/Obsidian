...
- ==Increasing== on an interval _I_ if: $f(x_1) < f(x_2) \quad \text{whenever } x_1 < x_2 \text{ in } I$
- ==Decreasing== on _I_ if: $f(x_1) > f(x_2) \quad \text{whenever } x_1 < x_2 \text{ in } I$
...
## New Functions form Old Functions
