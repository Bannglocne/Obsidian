...
2. ==Financial Intermediaries==: Financial institutions where savers can _indirectly_ provide funds to borrowers.
    - ==Banks==: The most familiar intermediary; they take deposits and use them to make loans, earning profit from the interest rate spread. They also provide a _medium of exchange_ (checks/debit cards).
...
- **Identity** is an equation that must be true because of the way the variables in the equation are defined
- **National Saving ($S$):** The total income in the economy that remains after paying for consumption and government purchases ($S = I$). (Assuming that the economy we are examining is closed)
- **Components of Saving:** National saving is split into **private saving** ([[Gross Domestic Product|Y - T - C]]) and **public saving** ($T - G$).
