...
A fundamental principle of finance is that money today is more valuable than the same amount of money in the future because of the ability to earn interest.
...
- **Compounding:** The accumulation of a sum of money in, say, a bank account, where the interest earned remains in the account to earn additional interest in the future
	- $(1+r)^{N} \times A$ after N years.
	- An amount X to be received in N years has a present value of $X \setminus (1+r)^{N}$: The process of finding a present value of a future sum of money is called _discounting_
### Managing Risk
Most people are **risk-averse**, meaning they dislike bad things more than they like comparable good things due to the diminishing marginal utility of wealth.
- **Insurance:** A way to spread risk. Instead of one person bearing the full burden of a disaster, the risk is shared among thousands of policyholders.
- **Diversification:** The practice of reducing risk by replacing a single risk with a large number of smaller, unrelated risks. It can eliminate **firm-specific risk** (affecting only one company) but cannot eliminate **[[Market]] risk** (affecting the entire economy).
- **Risk vs. Return:** Investors face a trade-off; higher average returns typically require accepting greater risk.
### Asset Valuation
Deciding what a share of stock is worth requires estimating the business's future profitability.
- **Fundamental Analysis:** The study of a company’s accounting statements and future prospects to determine its fair value. The value of that share of the business and the price at which the shares are being sold. If the price is _less/more/equal_ than the value, the stock is said to be _undervalued/overvalued/fairly valued_
- **Efficient Markets Hypothesis (EMH):** The theory that asset prices reflect all publicly available information about the value of an asset. According to EMH, the stock [[Market]] is **informally efficient**(the description of asset prices that rationally reflect all available information), and stock prices follow a **random walk**(the path of a variable whose changes are impossible to predict), making it impossible to consistently "beat the [[Market]]".
- **[[Market]] Irrationality:** Some economists argue that markets are driven by "animal spirits"—irrational waves of optimism or pessimism—which can lead to **speculative bubbles**.